...
def detectPlatesInScene(imgOriginalScene):
    ...
    listOfListsOfMatchingCharsInScene = Chars.findListOfListsOfMatchingChars(listOfPossibleCharsInScene)
...
def findPossibleCharsInScene(imgThresh):
    ...
    for i in range(0, len(contours)):                       
        ...
        possibleChar = PChar.PChar(contours[i])
...
def extractPlate(imgOriginal, listOfMatchingChars):
    possiblePlate = PPlate.PossiblePlate()           
